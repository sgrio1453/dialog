    ...
    <div className='h-[70vh] w-[60vw] bg-white flex overflow-hidden justify-between'>
      ...
      {/* sing up */}
        <div className='flex flex-col items-center w-1/2 py-10'>
            ...
            <form action="" className='w-full flex flex-col items-center space-y-6 mt-10 font-redHatDisplay'>
                <div className='flex items-center border-b-2 border-gray-300 space-x-2 w-2/3 hover:border-gray-600 duration-500'>
                    <span className='text-d-blue '><AccountCircleIcon/></span>
                    <input type="text" placeholder="Adınızı giriniz" className='outline-none w-full' required/>
                </div>
                <div className='flex items-center border-b-2 border-gray-300 space-x-2 w-2/3 hover:border-gray-600 duration-500'>
                    <span className='text-d-blue'><AccountCircleIcon/></span>
                    <input type="text" placeholder="Soyadınızı giriniz" className='outline-none w-full' required/>
                </div>
                <div className='flex items-center border-b-2 border-gray-300 space-x-2 w-2/3 hover:border-gray-600 duration-500'>
                ...
                <div className='flex items-center border-b-2 border-gray-300 space-x-2 w-2/3 hover:border-gray-600 duration-500'>
                    <span className='text-d-blue'><LocalPhoneIcon/></span>
                    <input type="tel" placeholder="Telefon numaranızı giriniz" className='outline-none w-full' required maxLength={10}/>
                </div>
                <div className='flex items-center border-b-2 border-gray-300 space-x-2 w-2/3 hover:border-gray-600 duration-500'>
                    <span className='text-d-blue'><AlternateEmailIcon/></span>
                    <input type="email" placeholder="e-posta giriniz" className='outline-none w-full' required/>
                </div>
                <div className='flex items-center border-b-2 border-gray-300 space-x-2 w-2/3 hover:border-gray-600 duration-500'>
